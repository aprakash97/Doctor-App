        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(speciality.equals("Select your specialization")){
                    Toast.makeText(DoctorRegistrationActivity.this, "Select blood Group", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            ...
                            Toast.makeText(DoctorRegistrationActivity.this, "Error1" +error , Toast.LENGTH_SHORT).show();
                            Log.d("ERROR", error);
                        }else{
...
//                            userInfo.put("password", password);
                            ...
                            userInfo.put("search","doctor"+speciality); //concat + filter

                            userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                @Override
                                public void onComplete(@NonNull Task task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(DoctorRegistrationActivity.this, "Data passed successful", Toast.LENGTH_SHORT).show();
                                    }else{
                                        Toast.makeText(DoctorRegistrationActivity.this, "Error2" +task.getException().toString(), Toast.LENGTH_SHORT).show();
                                    }
                                            ...
                                            result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                        ...
                                                        public void onComplete(@NonNull Task task) {
                                                            if(task.isSuccessful()){
                                                                Toast.makeText(DoctorRegistrationActivity.this, "Image URL ADDED TO Database successfully", Toast.LENGTH_SHORT).show();
                                                            }else{
                                                                Toast.makeText(DoctorRegistrationActivity.this, "Image URL ADDING FAILED", Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    });
